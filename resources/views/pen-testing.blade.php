                ...
                <ul>
                    <li>
                        <div class="row">
                            ...
                            <div class="col-10 col-md-11">Intelligently manage vulnerabilities</div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">Avoid the cost of network downtime</div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">Meet regulary requirements and avoid fines</div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">Preserve corporate image and customer loyalty</div>
                        </div>
                    </li>
                </ul>
            </div>
