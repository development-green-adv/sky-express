                                        ...
                                        <ul class="open-systems-first-ul">
                                            <li>
                                                <div class="row">
                                                    ...
                                                    <div class="col-10 col-md-11"><p>Open Systems pruža sve potrebne performanse i zaštitu</p></div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="row">
                                                    ...
                                                    <div class="col-10 col-md-11"><p>Smanjuje ranjivosti od potencijalnih sajber napada</p></div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
