                ...
                <ul>
                    <li>
                        <div class="row">
                            ...
                            <div class="col-10 col-md-11">90% brže rešavanje incidenata</div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">80% efikasnija analiza</div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">300% povećanje broja obrađenih incidenata</div>
                        </div>
                    </li>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="df-labs-sixth-part-middle-left">
                    ...
                    <div>
                        <p>Integrisani šabloni za postupanje u skladu sa <br class="d-none d-md-block">GDPR regulativom</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="df-labs-sixth-part-middle-right">
                    ...
                    <div>
                        <p>Formalizovan i upotrebljiv šablon za postupanje <br class="d-none d-md-block"> po odredbama GDPR-a</p>
                    </div>
                </div>
            </div>
        </div>
