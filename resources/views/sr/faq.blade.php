...
@section("title", "Najcesca pitanja | Sky Express")
            ...
            <div class="container">
                <div class="col-md-12">
                    <p style="font-size: 18px;">
                        Na ovoj strani ćete pronaći odgovore na neka od najčešćih pitanja o sajber bezbednosti, najboljim
                        praksama, procedurama i još mnogo toga. Ukoliko ne nađete odgovor na pitanje koje tražite,
                        obratite se timu Sky Express-a.
                    </p>
                </div>
            </div>
        </div>
