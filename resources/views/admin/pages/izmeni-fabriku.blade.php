...
@section('data')
    ...
    <div class="row">
        ...
        <form action="/admin/izmeni-fabriku" method="POST">
            @csrf
            ...
            <div class="col-12 col-md-10">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input class="form-control" type="text" name="fabrika" value="{{ $fabric->fabrika }}">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input class="form-control" type="text" name="link" value="{{ $fabric->link }}">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input class="form-control" type="text" name="telefon" value="{{ $fabric->telefon }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input class="form-control" type="text" name="email" value="{{ $fabric->email }}">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input class="form-control" type="text" name="adresa" value="{{ $fabric->adresa }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <textarea class="form-control" name="opis" cols="30" rows="10">{{ $fabric->opis }}</textarea>
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <div id="slike5">
                                ...
                                @if($fabric->logo != "")
                                    ...
                                    <div id="deleteGall{{ $fabric->id }}" style='margin-top: 10px;'>
                                        <div class="btn btn-danger" id="{{ $fabric->id }}" onclick="deleteGal(this)">-</div>
                                        <img class='img-responsive' src='/images_gallery/{{ $fabric->logo }}'/>
                                        <input type='hidden' name='galleryImages[]' value="{{ $fabric->logo }}" />
                                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <button style="margin-left: 153px;" class="btn btn-success">Sačuvaj</button>
                    </div>
                </div>
