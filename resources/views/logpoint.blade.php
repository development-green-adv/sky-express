                    ...
                    <li>
                        <div class="row">
                            ...
                            <div class="col-10 col-md-11">
                                <p>No company should be limited by the amount of data they can ingest into a SIEM system</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"> <img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">
                                <p>Simplified architectural principles to enable faster and more efficient software deployments</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"> <img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">
                                <p>World-class support available 24×7 to help
                                    customers get the most value from their SIEM system</p>
                            </div>
                        </div>
                    </li>
                </ul>
                    ...
                    <ul class="logpoint-ul-second-part">
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"> <img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11">
                                    <p class="pr-0 pr-md-5">Rapid analytic insight into incidents across the infrastructure;</p>
                                </div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"> <img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10  col-md-11">
                                    <p class="pr-0 pr-md-5">Removed dependencies of specific personnel with restricted system access;</p>
                                </div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"> <img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10  col-md-11">
                                    <p class="pr-0 pr-md-5">Big data analytics for sharp, easy analysis of all issues and
                                        incidents related all aspects of information system
                                        architecture – network, system, services and applications;</p>
                                </div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"> <img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10  col-md-11">
                                    <p class="pr-0 pr-md-5">Reduction of the number of false positives and eliminating the hassle of maintaining and developing expert rules;</p>
                                </div>
                            </div>
                        </li>
                        <li class="mb-5 mb-md-0">
                            <div class="row">
                                <div class="col-2 col-md-1"> <img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10  col-md-11">
                                    <p class="pr-0 pr-md-5">Forensic investigation with the execution of custom
                                        playbooks should an incident arise.</p>
                                </div>
                            </div>
                        </li>
                    </ul>
