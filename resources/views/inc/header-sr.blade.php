                                ...
                                <li class="nav-item position-relative">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="dropdown-menu-ul">
                                            ...
                                            <li><a href="#">DF Labs</a></li>
                                            <li><a href="#">Logpoint</a></li>
                                        ...
                                        <ul class="dropdown-menu-ul">
                                            <li><a href="/sr/resenja"><p>REŠENJA</p></a></li>
                                            <li class="position-relative"><a href="#">By Compliance</a>
                                                <ul class="dropdown-sub-menu">
                                                    <li class="invisible"><a href="#"><p>SOLUTIONS</p></a></li>
                                                    <li class="gdpr-link"><a href="#">Meeting GDPR</a></li>
