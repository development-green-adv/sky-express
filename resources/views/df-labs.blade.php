                ...
                <ul>
                    <li>
                        <div class="row">
                            ...
                            <div class="col-10 col-md-11">Minimize Incident resolution time by 90%</div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">Improve Analyst efficiency by 80%</div>
                        </div>
                    </li>
                    <li>
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">Increase handled incidents 300%</div>
                        </div>
                    </li>
                ...
                <div class="df-labs-fourth-part-right">
                    <ul>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11">Automation & Orchestration</div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11">Hunting & Investigation</div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11"> Flexible Integrations & Event Parsing</div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11">Forensic Evidence Management</div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11">Reporting & KPIs</div>
                            </div>
                        </li>
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11">Knowledge Transfer & Machine Learning</div>
                            </div>
                        </li>
                        <li>
                            <div class="row">
                                <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                                <div class="col-10 col-md-11">Community Portal & Community Edition</div>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="df-labs-sixth-part-middle-left">
                    ...
                    <div>
                        <p>Intergrated GDPR incident response and <br class="d-none d-md-block">breach notification playbooks</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="df-labs-sixth-part-middle-right">
                    ...
                    <div>
                        <p>Formalized, repeatable and enforceable incident <br class="d-none d-md-block"> response workflows form GDPR</p>
                    </div>
                </div>
            </div>
        </div>
