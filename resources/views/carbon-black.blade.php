            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="df-labs-right-first-part">
                        <p class="pl-0 pr-md-5 mb-4">Carbon Black offers solutions to all of organization's <br> security needs and uses a series of individual services <br> that run locally on your private network as well as <br> remotely in the cloud.</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="df-labs-second-part-left ">
                            ...
                            <h4 class="text-white mb-0 mb-md-3">Simplify Your Security Stack <br> and Improve Your Protection</h4>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="carbon-black-sixth-part-left">
                            ...
                            <p class="mb-5 pr-0 pr-md-5">Highly-scalable, real-time threat hunting and incident <br> response (IR) solution delivering unfiltered visibility for <br> top security operations centers and IR teams </p>
