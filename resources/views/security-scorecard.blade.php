                    ...
                    <li class="mb-4">
                        <div class="row">
                            ...
                            <div class="col-10 col-md-11">
                                <p><span>SECURITY RATINGS</span> - It all starts with a score</p>
                            </div>
                        </div>
                    </li>
                    <li class="mb-4">
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">
                                <p><span>ATLAS</span> - A Revolutionary Questionnaire and Evidence Exchange Platform</p>
                            </div>
                        </div>
                    </li>
                    <li class="mb-4">
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">
                                <p><span>THREATMARKET</span> - The intelligence behind the score</p>
                            </div>
                        </div>
                    </li>
                    <li class="mb-4">
                        <div class="row">
                            <div class="col-2 col-md-1"><img src="{{ asset('images/web/correct.svg') }}" alt=""></div>
                            <div class="col-10 col-md-11">
                                <p><span>API CONNECTORS</span> - Data and analytics are a pillar of our platform</p>
                            </div>
                        </div>
                    </li>
                </ul>
